<div class="float-left">
    <button type="button" wire:click.prevent="$emit('openModal', 'modals.form', {{ json_encode(['inputsView' => 'companies.inputs']) }})"
    ...
    <button type="button" wire:click.prevent="$emit('openModal', 'modals.confirm', {{ json_encode([ 'title' => __('Are you sure?'), 'description' => __('Do you realy sure that you want to exclude this register'), 'confirmAction' => $confirmAction, 'confirmBtnLabel' => $confirmBtnLabel, 'confirmBtnColor' => $confirmBtnColor ]) }})"
